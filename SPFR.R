...
DataFolder = "C:/Users/malle72/projects/spf"
InputCSV = "StateSegments.csv" #name of CSV in DataFolder (include extension)
CSVpath = paste0(DataFolder,InputCSV)
OutputProject_Base = "State Segment NW Screening--" #Output folder name (will be created in datafolder if it doesn't exist)
InputData_Base = "Urban 2 Lane 2019-2023" # be sure to uniquely describe the data so it can be traced back to the source
...
TotalColumn = "TL_5y" #The title of the column containing All Crashes. replace spaces with "." e.g. "Total.Crashes"
KABCColumn = "FI_5y" #The title of the column containing KABC Crashes. leave blank to ignore
KABColumn = "" #The title of the column containing KAB Crashes. leave blank to ignore
KAColumn = "" #The title of the column containing KA Crashes. leave blank to ignore
KColumn = "Fatal" #The title of the column containing K Crashes. leave blank to ignore
AADTColumn = "AADT" #The title of the column containing AADT. 
LengthColumn = "SegmentLength" #The title of the column containing Length. 
ClassColumn = "HighwayClassCode" #The title of the column containing a class category (integers). leave blank to ignore
ClassStart = 1 #Enter a positive integer. This will split the data into groups based on the Class defined above
ClassEnd = 43 #Enter a positive integer. This will split the data into groups based on the Class defined above
...
#myFilter_Base = paste0(myFilter_Base," & data$HighwayClassCode == 20"); OutputProject_Base = paste0(OutputProject_Base,"Urban 2-Lane")
...
#myFilter_Base = paste0(myFilter_Base," & data[[AADTColumn]] < 10000"); OutputProject_Base = paste0(OutputProject_Base," ADTLT10000")
